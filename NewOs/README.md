...
A simple operating system with basic features and a modular design.
...
- Interrupt masking
- System call support
- Fault handling (page fault, general protection fault)
...
- Thanks to all contributors who have helped with the development of SimpleOS
